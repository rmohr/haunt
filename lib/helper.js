...
// + Helper.untag - (accepts a tagname) removes a tag on an issue/pull-request
...
Helper.prototype.untag = function (label, callback) {
    github.untagIssue(this.repo.owner.login, this.repo.name, label, this.number, callback);
}
